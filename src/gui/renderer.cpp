...
void Renderer::initTexture()
{
    ...
    envTexture2StrMap[SKY1] = "sky1";
    envTexture2StrMap[SKY2] = "sky2";
    envTexture2StrMap[SKY3] = "sky3";
    ...
    for(int i = 1; i < NUM_ENVIRONMENT_TEXTURES; ++i)
    {
        ...
        QString posXFile = QString("textures/%1/posx.png").arg(envTexture2StrMap[tex]);
        TRUE_OR_DIE(QFile::exists(posXFile), "Cannot load texture from file.");

        QString negXFile = QString("textures/%1/negx.png").arg(envTexture2StrMap[tex]);
        TRUE_OR_DIE(QFile::exists(negXFile), "Cannot load texture from file.");

        QString posYFile = QString("textures/%1/posy.png").arg(envTexture2StrMap[tex]);
        TRUE_OR_DIE(QFile::exists(posYFile), "Cannot load texture from file.");

        QString negYFile = QString("textures/%1/negy.png").arg(envTexture2StrMap[tex]);
        TRUE_OR_DIE(QFile::exists(negYFile), "Cannot load texture from file.");

        QString posZFile = QString("textures/%1/posz.png").arg(envTexture2StrMap[tex]);
        TRUE_OR_DIE(QFile::exists(posZFile), "Cannot load texture from file.");

        QString negZFile = QString("textures/%1/negz.png").arg(envTexture2StrMap[tex]);
...
//        qDebug() << "GL_ARB_seamless_cube_map: disabled";
    ...
    floorTexture2StrMap[CHECKERBOARD1] = "checkerboard1.png";
    floorTexture2StrMap[CHECKERBOARD2] = "checkerboard2.png";
    floorTexture2StrMap[STONE1] = "stone1.png";
    floorTexture2StrMap[STONE2] = "stone2.png";
    floorTexture2StrMap[WOOD1] = "wood1.png";
    floorTexture2StrMap[WOOD2] = "wood2.png";

    TRUE_OR_DIE(floorTexture2StrMap.size() == (NUM_FLOOR_TEXTURES - 1),
                "Ohh, you forget to initialize some floor texture...");

    for(int i = 1; i < NUM_FLOOR_TEXTURES; ++i)
    {
